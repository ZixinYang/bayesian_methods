...
# print the posterior of p_A and p_B
ax = plt.subplot(311)
...
# Count the number of samples less than 0, i.e. the area under the curve before 0, represent the probability that site A is worse than site B.
